    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/5 min-h-[640px] lg:min-h-[760px]">
        <div className="pointer-events-none absolute inset-0">
          <img src="/hero-athlete.png" alt="" className="absolute inset-0 h-full w-full object-cover object-center opacity-25" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm text-center w-full max-w-sm shadow-2xl">
